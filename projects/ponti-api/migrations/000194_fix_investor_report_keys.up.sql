-- ========================================
-- MIGRATION 000194: Align investor report keys with UI expectations (UP)
-- ========================================
--
-- Objetivo: Ajustar las claves JSON de arriendo y administración en la vista final
--           para mantener compatibilidad con el frontend existente.
--           Se conservan los cálculos corregidos (rent_fixed_only + % acordados).
--
