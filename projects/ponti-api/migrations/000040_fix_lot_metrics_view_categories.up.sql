-- =======================
-- CORRECCIÓN DE VISTA LOT_METRICS_VIEW CON CATEGORÍAS REALES
-- =======================
-- Esta migración corrige la vista lot_metrics_view para usar las categorías correctas:
-- - lb.category_id = 9 (Siembra) para área sembrada
-- - lb.category_id = 13 (Cosecha) para área cosechada

-- Cambiar solo la categoría de cosecha de 2 a 13 en la vista existente
-- Usar un enfoque directo para evitar problemas de sintaxis

-- Primero, eliminar la vista existente
DROP VIEW IF EXISTS public.lot_metrics_view;

-- Luego, recrear la vista con la categoría correcta
