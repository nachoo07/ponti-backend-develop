-- ========================================
-- MIGRATION 000109: FIX CROP INCIDENCE WHEN OVER 99 PERCENT (DOWN)
-- ========================================
-- 
-- Purpose: Revertir a la versión 108 anterior
-- Date: 2025-01-27
-- Author: System
-- 
...
-- ========================================
-- REVERTIR VISTA v3_dashboard_crop_incidence A VERSIÓN 108
-- ========================================
-- Nota: Volver a lógica de diferencia ≤ 1%
