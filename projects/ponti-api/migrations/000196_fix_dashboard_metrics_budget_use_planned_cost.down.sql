-- ========================================
-- MIGRATION 000196: FIX Dashboard Metrics Budget Use Planned Cost (DOWN)
-- ========================================
--
-- Propósito: Revertir v3_dashboard_metrics al estado previo (admin_cost * 10).
...
COMMENT ON VIEW public.v3_dashboard_metrics IS 'Dashboard metrics. Estado previo a FIX 000196 (budget_cost_usd = admin_cost * 10).';
