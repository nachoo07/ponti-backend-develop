-- ========================================
-- MIGRACIÓN 000173: FIX Harvest Settlement Structure (DOWN)
-- ========================================
--
-- Propósito: Revertir la corrección de la estructura de harvest_settlement
-- Acción: Recrear la vista con la estructura de la migración 000172
-- Fecha: 2024-10-31
-- Autor: Sistema
--
BEGIN;

-- Revertir a la versión 000172 (con estructura vieja de harvest)
DROP VIEW IF EXISTS public.v3_investor_contribution_data_view CASCADE;

-- Recrear con estructura de 000172
