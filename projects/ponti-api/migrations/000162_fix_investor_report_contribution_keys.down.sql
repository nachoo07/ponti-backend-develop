-- ========================================
-- MIGRATION 000162: FIX INVESTOR REPORT CONTRIBUTION KEYS (DOWN)
-- ========================================
-- 
-- Purpose: Revertir corrección de keys de categorías
-- Date: 2025-10-21
-- Author: System
-- 
-- Note: Revierte a la versión 152

DROP VIEW IF EXISTS public.v3_investor_contribution_data_view CASCADE;

-- Restaurar vista de migración 152
