-- ========================================
-- MIGRACIÓN 000177: FIX Dashboard Labores Exclude Harvest (DOWN)
-- ========================================
--
-- Propósito: Revertir exclusión de Cosecha en labores invertidos
-- Fecha: 2025-11-03
-- Autor: Sistema

BEGIN;

-- Eliminar función nueva
DROP FUNCTION IF EXISTS v3_lot_ssot.labor_cost_pre_harvest_for_lot(bigint);

-- Restaurar vista anterior (versión 000166)
...
SELECT
  ...
  -- Costos Directos (versión 000166: incluye Cosecha)
  ...
  -- Labores (versión 000166: incluye Cosecha en invertidos)
...
COMMENT ON VIEW public.v3_dashboard_management_balance IS 'Balance de gestión para Dashboard.';
