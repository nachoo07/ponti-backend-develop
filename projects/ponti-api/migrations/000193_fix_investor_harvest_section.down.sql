-- ========================================
-- MIGRATION 000193: Fix harvest section structure in investor report (DOWN)
-- ========================================
--
-- Objetivo: Revertir la vista final a la versión previa (sin filas ni footers)
--           por si se necesita volver al formato anterior.
--
...
SELECT
  ...
  -- =========================================================================
  -- SECCIÓN 4: LIQUIDACIÓN DE COSECHA (FORMATO ANTERIOR)
  -- =========================================================================
  jsonb_build_object(
    -- Total de Cosecha
    ...
    'investors', (
      SELECT jsonb_agg(
        jsonb_build_object(
          ...
          -- COSECHA PAGADO (distribuido según % acordado - simplificación anterior)
...
COMMENT ON VIEW public.v3_investor_contribution_data_view IS 
  'Vista 4/4 (FINAL) para informe de Aportes por Inversor. Consolida las 3 vistas anteriores y genera la estructura JSON completa para la API. Incluye: Datos Generales, Categorías de Aportes, Comparación Aportado vs. Real, y Liquidación de Cosecha. Recreada en migración 146 para asegurar consistencia entre local y GCP.';
