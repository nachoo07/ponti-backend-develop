-- +goose Down
-- Revierte los keys de las categorías de Arriendo y Administración a los valores originales
-- Cambios: 'capitalizable_lease' → 'rent_capitalizable', 'administration_structure' → 'administration'
...
SELECT 
  ...
  (
    ...
    FROM (
      ...
      -- REVERTIR: 'capitalizable_lease' → 'rent_capitalizable'
      ...
      -- REVERTIR: 'administration_structure' → 'administration'
...
COMMENT ON VIEW v3_investor_contribution_data_view IS 
  'Vista consolidada para informe de aportes de inversores v3. Keys revertidos a originales: rent_capitalizable, administration.';
