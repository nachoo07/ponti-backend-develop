-- ========================================
-- MIGRATION 000083: FIX admin_cost IN v3_lot_views (UP)
-- ========================================
-- 
-- Purpose: Fix admin_cost to use project.admin_cost directly without calculations
-- Date: 2025-01-27
-- Author: System
-- 
...
-- -------------------------------------------------------------------
-- v3_lot_metrics: corregir admin_cost para usar project.admin_cost directamente
-- -------------------------------------------------------------------
...
SELECT
  ...
  -- CORREGIDO: Usar project.admin_cost directamente sin cálculos
  ...
  -- Totales
  -- CORREGIDO: Usar project.admin_cost directamente sin multiplicar
...
-- -------------------------------------------------------------------
-- v3_lot_list: corregir admin_cost para usar project.admin_cost directamente
-- -------------------------------------------------------------------
