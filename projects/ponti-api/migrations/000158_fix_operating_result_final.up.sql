-- ========================================
-- MIGRACIÓN 000158: FIX OPERATING RESULT FINAL - Calcular desde componentes de la vista (UP)
-- ========================================
--
-- Propósito: Corregir el cálculo de operating_result_per_ha_usd para que use
--            EXACTAMENTE los mismos valores que se muestran en las columnas de la vista.
-- Problema REAL: Hay DOS fuentes de verdad para direct_cost_per_ha:
--                1. v3_lot_metrics.direct_cost_per_ha_usd = direct_cost / sowed_area_ha
--                2. v3_lot_ssot.cost_per_ha_for_lot() = direct_cost / hectares
--                Y v3_lot_ssot.active_total_per_ha_for_lot() usa la opción 2.
-- Solución: En v3_lot_metrics, calcular operating_result como:
--           income_net_per_ha - (direct_cost_per_ha + rent_per_ha + admin_per_ha)
--           donde TODOS los valores vienen de las columnas ya calculadas en la vista.
-- Fecha: 2025-10-21
-- Autor: Sistema
--
...
-- CTE para calcular todos los valores por hectárea PRIMERO
...
SELECT
  ...
  -- ############### FIX FINAL ###############
  -- active_total_per_ha = suma de los componentes YA CALCULADOS en este CTE
  (direct_cost_per_ha_usd + rent_per_ha_usd + admin_cost_per_ha_usd)::numeric AS active_total_per_ha_usd,
  
  -- operating_result_per_ha = income_net_per_ha - active_total_per_ha
...
COMMENT ON VIEW public.v3_lot_list IS 'Listado de lotes - valores directos desde v3_lot_metrics';

-- ========================================
-- RECREAR v3_dashboard_metrics (eliminada por CASCADE)
-- ========================================
