-- ========================================
-- MIGRACIÓN 000119: CREATE v3_lot_metrics (UP)
-- ========================================
-- 
-- Propósito: Crear vista v3_lot_metrics usando v3_workorder_metrics como fuente única
-- Dependencias: Requiere v3_core_ssot (000113), v3_workorder_metrics (000117), y v3_lot_ssot (000115)
-- Cambios: Usa v3_workorder_metrics para costos directos (SSOT único)
-- Fecha: 2025-10-04
-- Autor: Sistema
-- 
