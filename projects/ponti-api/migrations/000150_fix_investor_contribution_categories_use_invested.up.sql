-- ========================================
-- MIGRATION 000150: FIX INVESTOR CONTRIBUTION CATEGORIES USE INVESTED (UP)
-- ========================================
-- 
-- Purpose: Corregir vista v3_report_investor_contribution_categories para usar datos INVERTIDOS
-- Date: 2025-10-14
-- Author: System
-- 
-- Problema identificado:
--   La vista usa v3_lot_ssot.supply_cost_for_lot_by_category() que lee workorder_items (EJECUTADO)
--   Debe leer de supply_movements (INVERTIDO) para el informe de Aportes
--
-- Corrección:
--   - Agroquímicos: Sumar desde supply_movements (tipo Stock + Remito oficial)
--   - Semillas: Sumar desde supply_movements (tipo Stock + Remito oficial)
--   - Labores: Mantener desde workorders (es correcto)
--   - Arriendo/Admin: Mantener (es correcto)
--
-- Impacto:
...
-- ============================================================================
-- RECREAR VISTA 2: v3_report_investor_contribution_categories (CON DATOS INVERTIDOS)
-- ============================================================================
...
SELECT
  ...
  -- Cómo se calcula: Suma de supply_movements (Stock + Remito oficial)
  --                  de categorías: Coadyuvantes, Curasemillas, 
  ...
  -- NOTA: workorders representa el presupuesto/invertido para labores
  -- =========================================================================
  COALESCE((
...
COMMENT ON VIEW public.v3_report_investor_contribution_categories IS 
  'Vista 2/4 para informe de Aportes por Inversor. CORREGIDO 150: Lee INVERTIDOS de supply_movements para insumos, workorders para labores. Usa funciones SSOT donde existen (rent_per_ha_for_lot, admin_cost_per_ha_for_lot).';

-- ============================================================================
-- RECREAR VISTA 3: v3_report_investor_distributions
-- ============================================================================
-- Copiar desde migración 000149
...
-- Aportes INVERTIDOS de agroquímicos por inversor (desde supply_movements)
...
-- Aportes INVERTIDOS de semillas por inversor (desde supply_movements)
...
-- Aportes de labores generales por inversor (desde workorders)
...
-- Aportes de siembra por inversor (desde workorders)
...
-- Aportes de riego por inversor (desde workorders)
...
COMMENT ON VIEW public.v3_report_investor_distributions IS 
  'Vista 3/4 para informe de Aportes por Inversor. CORREGIDO 150: Lee aportes INVERTIDOS de supply_movements.investor_id para insumos, workorders.investor_id para labores. Arriendo y Admin con valor fake 100 temporal.';

-- ============================================================================
-- RECREAR VISTA 4: v3_investor_contribution_data_view
-- ============================================================================
-- Copiar desde migración 000149 (sin cambios, solo se recrea por dependencia)
...
COMMENT ON VIEW public.v3_investor_contribution_data_view IS 
  'Vista 4/4 para informe de Aportes por Inversor. CORREGIDO 150: Usa aportes INVERTIDOS de supply_movements para insumos. Arriendo y Admin con valor fake 100 temporal.';
