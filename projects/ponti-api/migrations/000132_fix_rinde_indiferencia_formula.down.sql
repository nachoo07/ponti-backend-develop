-- ========================================
-- MIGRACIÓN 000132: FIX RINDE INDIFERENCIA FORMULA (DOWN)
-- ========================================
-- 
-- Propósito: Revertir la corrección de la fórmula del Rinde de Indiferencia
-- Restaura la fórmula anterior (incorrecta) de la migración 000130
-- Fecha: 2025-10-11
-- Autor: Sistema
...
-- ========================================
-- RESTAURAR VISTA DE RENTABILIDAD CON FÓRMULA ANTERIOR
-- ========================================
...
SELECT
  ...
  -- Rinde Indiferencia = Total Invertido / Rendimiento (FÓRMULA ANTERIOR - INCORRECTA)
  v3_core_ssot.safe_div(
