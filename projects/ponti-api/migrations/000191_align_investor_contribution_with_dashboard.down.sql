-- ========================================
-- MIGRATION 000188: FIX RENT CALCULATION IN INVESTOR CONTRIBUTION (UP)
-- ========================================
-- 
-- Purpose: Cambio QUIRÚRGICO - Solo 1 línea en v3_report_investor_contribution_categories
--          Cambiar: v3_calc.rent_per_ha_for_lot() → v3_lot_ssot.rent_fixed_only_for_lot()
--          Resultado esperado: Arriendo de 162,692 USD a 119,770 USD
--
-- Date: 2025-11-08
-- Author: System
-- 
...
-- ============================================================================
-- DROP CASCADE en las 3 vistas en orden inverso
-- ============================================================================
-- Usar CASCADE en todas porque tienen dependencias cruzadas
...
-- ============================================================================
-- QUIRÚRGICO: Solo cambiar la función de rent en línea 243
-- Mantener EXACTAMENTE todas las columnas en el mismo orden
...
SELECT
  ...
  -- FIX 000189: Agregar Fertilizantes (faltaba esta columna)
  COALESCE(SUM(
    v3_lot_ssot.supply_cost_for_lot_by_category(lb.lot_id, 'Fertilizantes')
  ...
  -- FIX 000188: CAMBIO QUIRÚRGICO AQUÍ
  -- ANTES: v3_calc.rent_per_ha_for_lot(lb.lot_id)::numeric * lb.hectares
  -- AHORA: v3_lot_ssot.rent_fixed_only_for_lot(lb.lot_id)::numeric * lb.hectares
  COALESCE(SUM(
...
COMMENT ON VIEW public.v3_report_investor_contribution_categories IS 
  'Vista 2/4 para informe de Aportes por Inversor. FIX 000188: Arriendo usa rent_fixed_only_for_lot(). Usa funciones SSOT.';
