-- ========================================
-- MIGRATION 000146: RECREATE INVESTOR CONTRIBUTION VIEWS (UP)
-- ========================================
-- 
-- Purpose: Recrear vistas de investor contribution para asegurar consistencia
-- Date: 2025-10-14
-- Author: System
-- 
-- Context: La migración 135 se ejecutó diferente en local vs GCP:
--          - Local: con DROP CASCADE (después del reset)
--          - GCP: con código original (sin DROP CASCADE previo)
--          Esta migración asegura que ambos ambientes tengan vistas idénticas.
--
...
-- ============================================================================
-- Eliminar las vistas existentes para recrearlas con estructura consistente
