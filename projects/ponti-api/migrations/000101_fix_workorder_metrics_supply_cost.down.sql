-- ========================================
-- MIGRACIÓN 000101: FIX WORKORDER METRICS SUPPLY COST (DOWN)
-- ========================================
-- 
-- Propósito: Revertir la corrección de la métrica de costos directos
-- Fecha: 2025-01-01
-- Autor: Sistema

-- -------------------------------------------------------------------
-- 1. RESTAURAR VISTA ORIGINAL v3_workorder_metrics
-- -------------------------------------------------------------------
...
-- -------------------------------------------------------------------
-- 2. ELIMINAR FUNCIÓN ESPECÍFICA PARA WORKORDERS
-- -------------------------------------------------------------------
DROP FUNCTION IF EXISTS v3_calc.supply_cost_for_workorder(bigint);
