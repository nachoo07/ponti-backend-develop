-- ========================================
-- MIGRACIÓN 000180: FIX Report Field Crop Indifference Yield Formula (UP)
-- ========================================
--
-- Propósito: Corregir cálculo de "Rinde de indiferencia" en reporte por campo/cultivo
-- Problema: El campo rinde_indiferencia_usd_tn está calculando PRECIO de indiferencia
--           en lugar de RINDE de indiferencia
--           
--           ACTUAL (INCORRECTO):
--             Rinde Indiferencia = Total Invertido/Ha / Rendimiento
--                                = $499/Ha / 0.56 Tn/Ha  
--                                = $894/Tn  ❌ (esto es PRECIO, no RINDE)
--           
--           CORRECTO:
--             Rinde Indiferencia = Total Invertido/Ha / Precio Neto
--                                = $499/Ha / $950/Tn
--                                = 0.53 Tn/Ha  ✅
--
-- Interpretación:
--   - Rinde de Indiferencia: ¿Cuánto debo cosechar para cubrir costos? (Tn/Ha)
--   - Precio de Indiferencia: ¿A qué precio debo vender para cubrir costos? (u$/Tn)
--
-- Fecha: 2025-11-03
-- Autor: Sistema
--
-- Impacto: Valores en tabla superior del reporte coincidirán con sección REL ING/GASTOS
--          Ejemplo: 0.53 Tn/Ha en lugar de 894.09 Tn/Ha
--
...
-- ========================================
-- RECREAR: v3_report_field_crop_rentabilidad
-- SOLO cambio: fórmula de rinde_indiferencia_total_usd_tn
-- ========================================
...
aggregated AS (
  SELECT
    ...
    -- Costos directos: incluir TODAS las categorías
    SUM(
...
SELECT
  ...
  -- ========================================
  -- FIX: Rinde de Indiferencia (CORRECTO)
  -- ========================================
  -- ANTES (INCORRECTO): Total Invertido/Ha / Rendimiento = PRECIO (u$/Tn)
  -- AHORA (CORRECTO): Total Invertido/Ha / Precio Neto = RINDE (Tn/Ha)
  --
  -- Fórmula: Rinde Indiferencia = Total Invertido/Ha / Precio Neto
  -- Ejemplo: $499/Ha / $950/Tn = 0.53 Tn/Ha
  -- Interpretación: Necesito cosechar mínimo 0.53 Tn/Ha para cubrir costos
  v3_core_ssot.safe_div(
...
COMMENT ON VIEW public.v3_report_field_crop_rentabilidad IS 
'Vista 5/5: RENTABILIDAD - FIX 000180: Rinde indiferencia usa Precio Neto en denominador.';

-- ========================================
-- RECREAR: v3_report_field_crop_metrics
-- (Se eliminó por CASCADE al dropear rentabilidad)
-- ========================================
...
SELECT
  ...
  -- De RENTABILIDAD (con COALESCE para manejar NULL de LEFT JOIN) - incluye fix de rinde_indiferencia
...
'Vista principal consolidada para reporte field-crop. FIX 000180: Rinde indiferencia correcto (Tn/Ha).';
