-- ========================================
-- MIGRATION 000199: FIX Operational Indicators Workorder Numbers As Text (DOWN)
-- ========================================
--
-- Propósito: Revertir funciones/vista para volver a usar bigint.
...
'Retorna número visible de primera orden (casteado a bigint).';
...
'Retorna número visible de última orden (casteado a bigint).';
...
'Indicadores operativos con números de OT casteados a bigint.';
