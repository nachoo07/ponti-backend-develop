-- ========================================
-- MIGRACIÓN 000111: FIX HARDCODED BALANCE EXECUTED VALUES (UP)
-- ========================================
-- 
-- Propósito: Corregir valores hardcodeados de arriendo_ejecutados_usd y estructura_ejecutados_usd
-- Nota: Reemplazar 0::double precision por cálculos reales (admin_cost * hectares)
-- Fecha: 2025-10-03
-- Autor: Sistema
...
SELECT
  ...
  -- ========================================
  -- ARRIENDO (EJECUTADOS + INVERTIDOS, STOCK = NULL) - CORREGIDO EN 000111
  -- ========================================
  -- Ejecutados: lease_type_value * total_hectares (mismo cálculo que invertidos)
  COALESCE((SELECT f.lease_type_value * ph.total_hectares
            FROM public.fields f
            WHERE f.project_id = p.id AND f.deleted_at IS NULL
            LIMIT 1), 0)::double precision AS arriendo_ejecutados_usd,
  ...
  -- ========================================
  -- ESTRUCTURA (EJECUTADOS + INVERTIDOS, STOCK = NULL) - CORREGIDO EN 000111
  -- ========================================
  -- Ejecutados: admin_cost * total_hectares (mismo cálculo que invertidos)
