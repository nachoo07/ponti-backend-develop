-- =============================================================================
-- Migration: 000321_fix_rentabilidad_use_rent_total
-- Description: Corrige field_crop_rentabilidad para usar arriendo configurado
-- El arriendo siempre es UNO: el que resulta de la configuración del campo
-- =============================================================================
...
aggregated AS (
  SELECT
    ...
    -- FIX 000321: Usar arriendo configurado (rent_per_ha_for_lot), NO rent_fixed_only
    SUM(v3_lot_ssot.rent_per_ha_for_lot(lot_id) * sowed_area_ha)::numeric AS rent_usd,
...
'FIX 000321: Usa arriendo configurado (rent_per_ha_for_lot) en Total Activo.';

-- =============================================================================
-- Recrear FIELD_CROP_METRICS (depende de rentabilidad)
-- =============================================================================
