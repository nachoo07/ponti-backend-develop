-- ========================================
-- MIGRATION 000162: FIX INVESTOR REPORT CONTRIBUTION KEYS (UP)
-- ========================================
-- 
-- Purpose: Corregir los keys de las categorías de contribución para que coincidan con el DTO
-- Date: 2025-10-21
-- Author: System
-- 
-- Problema identificado:
--   La vista SQL usa:
--     - 'rent_capitalizable' pero el DTO espera 'capitalizable_lease'
--     - 'administration' pero el DTO espera 'administration_structure'
--
-- Corrección:
--   Cambiar los keys en la vista v3_investor_contribution_data_view
--
-- Impacto:
--   - Solo afecta informe de Aportes por Inversor
--   - Las filas de Arriendo y Administración ahora se mostrarán correctamente
--
-- Note: Code in English, comments in Spanish.

-- ============================================================================
-- RECREAR VISTA: v3_investor_contribution_data_view (CON KEYS CORRECTOS)
-- ============================================================================
...
SELECT 
  ...
  (
    ...
    FROM (
      ...
      FROM contribution_categories cc WHERE cc.project_id = pb.project_id
      UNION ALL
      -- CORREGIDO: Cambiar 'rent_capitalizable' por 'capitalizable_lease'
      ...
      FROM contribution_categories cc WHERE cc.project_id = pb.project_id
      UNION ALL
      -- CORREGIDO: Cambiar 'administration' por 'administration_structure'
