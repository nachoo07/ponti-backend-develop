-- ========================================
-- MIGRACIÓN 000112: FIX ARRIENDO EJECUTADO BY TYPE (DOWN)
-- ========================================
-- 
-- Propósito: Revertir a la versión 000111 donde todos los tipos calculaban igual

-- Eliminar vista existente si existe
DROP VIEW IF EXISTS public.v3_dashboard_management_balance CASCADE;

-- Restaurar vista de migración 000111 (sin distinción por tipo de arriendo)
...
SELECT
  ...
  -- ========================================
  -- ARRIENDO (EJECUTADOS + INVERTIDOS, STOCK = NULL) - VERSION 000111
  -- ========================================
  COALESCE((SELECT f.lease_type_value * ph.total_hectares
