-- ========================================
-- MIGRATION 000190: FIX Dashboard Operating Result Rent Calculation (DOWN)
-- ========================================
--
-- Purpose: Revert function v3_dashboard_ssot.operating_result_total_for_project to previous rent_per_ha usage.
--
-- Date: 2025-11-08
-- Author: System
--
...
-- ============================================================================
-- Restaurar función original con rent_per_ha_for_lot()
-- ============================================================================
...
'Calcula el resultado operativo total del proyecto. Versión original con rent_per_ha_for_lot().';
