-- ========================================
-- MIGRACIÓN 000144: FIX v3_lot_list - Use lot-specific cost per ha (DOWN)
-- ========================================
-- 
-- Propósito: Revertir v3_lot_list a usar cost_per_ha_for_crop_ssot
-- Revierte a: Usar promedio por cultivo (comportamiento anterior)
-- Fecha: 2025-10-13
-- Autor: Sistema
-- 
...
-- ========================================
-- RESTAURAR v3_lot_list A VERSIÓN ANTERIOR
-- ========================================
