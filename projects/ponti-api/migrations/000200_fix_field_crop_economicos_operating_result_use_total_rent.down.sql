-- ========================================
-- MIGRACIÓN 000200: FIX Field Crop Economicos Operating Result - Use Total Rent (DOWN)
-- ========================================
--
-- Rollback: Revertir a usar rent_fixed_only para resultado_operativo_usd
-- Fecha: 2025-11-17
-- Autor: Sistema
--
...
-- Revertir: Usar rent_fixed_only para resultado_operativo_usd
-- ========================================
