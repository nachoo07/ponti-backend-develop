-- ========================================
-- MIGRACIÓN 000173: FIX Harvest Settlement Structure (UP)
-- ========================================
--
-- Propósito: Corregir la estructura JSON de 'harvest_settlement' en v3_investor_contribution_data_view
-- Problema: La migración 000172 tiene la estructura vieja {total_harvest_usd, total_harvest_usd_ha, investors}
--           pero el Go model y el frontend esperan {rows, footer_payment_agreed, footer_payment_adjustment}
...
-- Recrear v3_investor_contribution_data_view con estructura correcta de harvest
...
SELECT
  ...
  -- ✅ FIX: Estructura correcta con valores REALES de cosecha desde workorders
  jsonb_build_object(
    'rows', jsonb_build_array(
      ...
      -- Fila "Totales" (igual que "Cosecha" en este caso)
      jsonb_build_object(
        'key', 'totals',
        'type', 'totals',
        'total_usd', COALESCE(ht.total_harvest_usd, 0),
    ...
    -- Footer: Pago acordado por inversor (basado en % acordado)
    ...
    -- Footer: Ajuste de pago (diferencia entre pago real y acordado)
...
COMMENT ON VIEW public.v3_investor_contribution_data_view IS 'Vista FINAL para informe de Aportes por Inversor. FIX 000173: Harvest settlement con estructura correcta (rows, footer_payment_agreed, footer_payment_adjustment).';
