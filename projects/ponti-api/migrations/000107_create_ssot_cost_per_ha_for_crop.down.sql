-- ========================================
-- MIGRATION 000107: CREATE SSOT COST PER HA FOR CROP (DOWN)
-- ========================================
-- 
-- Purpose: Revertir función SSOT para costo por hectárea por cultivo
-- Date: 2025-01-27
-- Author: System
-- 
...
-- ========================================
-- REVERTIR VISTA A VERSIÓN ANTERIOR
-- ========================================
-- Revertir a la vista de la migración 000106
...
SELECT
  ...
  -- Costo directo por hectárea del cultivo (función anterior)
...
-- ========================================
-- ELIMINAR FUNCIÓN SSOT
-- ========================================
DROP FUNCTION IF EXISTS v3_calc.cost_per_ha_for_crop_ssot(bigint, bigint);
