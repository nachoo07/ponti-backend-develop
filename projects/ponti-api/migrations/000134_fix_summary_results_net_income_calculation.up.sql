-- ========================================
-- MIGRATION 000133: FIX SUMMARY RESULTS NET INCOME CALCULATION (UP)
-- ========================================
-- 
-- Purpose: Corregir cálculo de ingreso neto en v3_report_summary_results_view
-- Date: 2025-10-11
-- Author: System
-- 
-- Problema identificado:
--   La vista actual calcula: ingreso_neto = superficie_ha × net_price_usd_tn
--   Esto es incorrecto porque net_price está en usd/tn, no en usd/ha
--
-- Corrección:
--   ingreso_neto = producción_tn × net_price_usd_tn
--
-- Impacto:
--   - Cultivos sin producción ahora mostrarán ingreso=0 (correcto)
--   - operating_result_usd se recalcula correctamente
--   - crop_return_pct se recalcula correctamente
--
